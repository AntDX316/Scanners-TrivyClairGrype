...
<head>
    ...
    <style>
        ...
        @media (max-width: 768px) {{ .description {{ max-width: 250px; }} }}
        .footer {{ text-align: center; margin-top: 40px; padding: 10px 20px 5px 20px; border-top: 2px solid #e0e0e0; color: #666; }}
